...
export const metadata: Metadata = {
  ...
  description:
    'View the complete academic calendar for JKKN College of Engineering including semester schedules, learning assessment dates, holidays, important events, and deadlines for the academic year 2024-2025.',
  keywords: [
    'academic calendar',
    'JKKN calendar',
    'semester schedule',
    'learning assessment dates',
    'college holidays',
    'academic year',
    'event calendar',
    'JKKN engineering',
  ...
  openGraph: {
    title: 'Academic Calendar 2024-2025 | JKKN College of Engineering',
    description:
      'Stay updated with all important academic dates, events, learning assessments, and holidays. Complete academic calendar for JKKN College of Engineering.',
    type: 'website',
  ...
  twitter: {
    ...
    description:
      'Complete academic calendar with semester schedules, learning assessment dates, holidays, and important events.',
  },
}
    ...
    <main>
      ...
      <MainInstitutionPageSchema
        webpage={{
          ...
          description:
            'Academic calendar for JKKN Institutions — semester schedule, learning assessments, holidays, and important academic events across the 7 colleges.',
          keywords: [
            'academic calendar',
            'JKKN calendar',
            'semester schedule',
