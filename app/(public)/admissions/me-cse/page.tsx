...
export const metadata: Metadata = {
  ...
  description:
    'Apply for M.E Computer Science & Engineering at JKKN College of Engineering & Technology for 2026-27. AICTE approved, NAAC accredited. 12 seats, ₹30,000 fee, TANCET + Direct Merit admission. Advanced Algorithms, Data Science, Network Security specializations.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      '12 seats · ₹30,000/yr (most affordable PG engineering) · TANCET or Direct Merit. Advanced Algorithms, Data Science, Network Security.',
    type: 'website',
