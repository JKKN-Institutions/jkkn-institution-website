...
const categories: NIRFCategory[] = [
  {
    title: 'Engineering',
    downloadUrl: '/documents/nirf/2026/engineering.pdf',
  },
  {
    title: 'Management',
    downloadUrl: '/documents/nirf/2026/management.pdf',
  },
  {
    title: 'Innovation',
    downloadUrl: '/documents/nirf/2026/innovation.pdf',
  },
  {
    title: 'Overall',
    downloadUrl: '/documents/nirf/2026/overall.pdf',
  },
]

export default function NIRF2026Page() {
  useEffect(() => {
    document.title = 'NIRF 2026 | IQAC | JKKN'
  }, [])

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF8E7] via-[#F5E6D3] to-[#FFF8E7]">
      <BreadcrumbSchema path="/iqac/nirf/nirf-2026" />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-gray-600">
              National Institutional Ranking Framework (NIRF) 2026 Reports
            </p>
          </div>
        </div>
      </div>
