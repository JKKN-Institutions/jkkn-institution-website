...
export const metadata: Metadata = {
  title: '2021-2022 Feedback | JKKN Institutions',
  description:
    'Learner, Alumni, Parents, and Senior Learners feedback reports for the academic year 2021-2022.',
  keywords: [
    'feedback',
    '2021-2022',
    'learner feedback',
...
const feedbackCategories = [
  {
    id: 'learner',
    label: 'learner',
    pdfPath: '/pdfs/feedback/2021-2022/student-feedback-2021-2022.pdf',
  },
  {
    id: 'alumni',
    label: 'Alumni',
    pdfPath: '/pdfs/feedback/2021-2022/alumni-feedback-2021-2022.pdf',
  },
  {
    id: 'parents',
    label: 'parents',
    pdfPath: '/pdfs/feedback/2021-2022/parents-feedback-2021-2022.pdf',
  },
  {
    id: 'senior learners',
    label: 'Senior Learners',
    pdfPath: '/pdfs/feedback/2021-2022/faculty-feedback-2021-2022.pdf',
  },
]

export default function Feedback20212022Page() {
  return (
