...
console.error('    Set it to the exact production origin for THIS institution, https, no trailing slash.')
console.error('    main = https://www.jkkn.ac.in - WITH www. The site 308s to www, and the')
console.error('    sitemap, the robots.txt Sitemap: line and its Host: line all declare www.')
console.error('    The college subdomains carry no www, e.g. https://engg.jkkn.ac.in.')
