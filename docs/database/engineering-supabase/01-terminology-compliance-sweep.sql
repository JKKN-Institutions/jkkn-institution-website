-- ============================================
-- 01 — JKKN Terminology Sweep (Engineering Supabase, full content)
-- ============================================
...
WHERE id IN (SELECT id FROM bak_cms_pages_eng);

-- cms_page_blocks
DROP TABLE IF EXISTS bak_cms_page_blocks_eng;
CREATE TABLE bak_cms_page_blocks_eng AS SELECT id, props FROM cms_page_blocks WHERE (coalesce(props::text,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE cms_page_blocks SET
  props = jkkn_jsonb_fix(props)
WHERE id IN (SELECT id FROM bak_cms_page_blocks_eng);

-- cms_seo_metadata
DROP TABLE IF EXISTS bak_cms_seo_metadata_eng;
CREATE TABLE bak_cms_seo_metadata_eng AS SELECT id, meta_title, meta_description, og_title, og_description, twitter_title, twitter_description, structured_data, meta_keywords FROM cms_seo_metadata WHERE (coalesce(meta_title,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(meta_description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(og_title,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(og_description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(twitter_title,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(twitter_description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(structured_data::text,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(array_to_string(meta_keywords,' '),'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
...
WHERE id IN (SELECT id FROM bak_cms_seo_metadata_eng);

-- blog_posts
DROP TABLE IF EXISTS bak_blog_posts_eng;
CREATE TABLE bak_blog_posts_eng AS SELECT id, title, excerpt, seo_title, seo_description, content, metadata, seo_keywords FROM blog_posts WHERE (coalesce(title,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(excerpt,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(seo_title,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(seo_description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(content::text,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(metadata::text,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(array_to_string(seo_keywords,' '),'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
...
WHERE id IN (SELECT id FROM bak_blog_posts_eng);

-- site_settings  (filter: setting_key LIKE 'footer%')
DROP TABLE IF EXISTS bak_site_settings_eng;
CREATE TABLE bak_site_settings_eng AS SELECT id, setting_value FROM site_settings WHERE ((coalesce(setting_value::text,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y')) AND (setting_key LIKE 'footer%');
UPDATE site_settings SET
  setting_value = jkkn_jsonb_fix(setting_value)
WHERE id IN (SELECT id FROM bak_site_settings_eng);

-- blog_categories
DROP TABLE IF EXISTS bak_blog_categories_eng;
CREATE TABLE bak_blog_categories_eng AS SELECT id, name, description FROM blog_categories WHERE (coalesce(name,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE blog_categories SET
  name = jkkn_term_fix(name),
  description = jkkn_term_fix(description)
WHERE id IN (SELECT id FROM bak_blog_categories_eng);

-- education_videos
DROP TABLE IF EXISTS bak_education_videos_eng;
CREATE TABLE bak_education_videos_eng AS SELECT id, title, description FROM education_videos WHERE (coalesce(title,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE education_videos SET
  title = jkkn_term_fix(title),
  description = jkkn_term_fix(description)
WHERE id IN (SELECT id FROM bak_education_videos_eng);

-- colleges
DROP TABLE IF EXISTS bak_colleges_eng;
CREATE TABLE bak_colleges_eng AS SELECT id, name, description FROM colleges WHERE (coalesce(name,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE colleges SET
  name = jkkn_term_fix(name),
  description = jkkn_term_fix(description)
WHERE id IN (SELECT id FROM bak_colleges_eng);

-- courses
DROP TABLE IF EXISTS bak_courses_eng;
CREATE TABLE bak_courses_eng AS SELECT id, name FROM courses WHERE (coalesce(name,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE courses SET
  name = jkkn_term_fix(name)
WHERE id IN (SELECT id FROM bak_courses_eng);

-- faculty
DROP TABLE IF EXISTS bak_faculty_eng;
CREATE TABLE bak_faculty_eng AS SELECT id, professional_summary, mentoring_description, faqs FROM faculty WHERE (coalesce(professional_summary,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(mentoring_description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(faqs::text,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE faculty SET
  professional_summary = jkkn_term_fix(professional_summary),
  mentoring_description = jkkn_term_fix(mentoring_description),
  faqs = jkkn_jsonb_fix(faqs)
WHERE id IN (SELECT id FROM bak_faculty_eng);

-- achievement_categories
DROP TABLE IF EXISTS bak_achievement_categories_eng;
CREATE TABLE bak_achievement_categories_eng AS SELECT id, name, description FROM achievement_categories WHERE (coalesce(name,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y' OR coalesce(description,'') ~* '\y(student|students|pupils?|trainees?|faculty|teachers?|professors?|instructors?|tutors?|educators?|staff|employees?|workers?|classrooms?|laborator|labs?|syllab|curricul|examination|exams?|homework|assignments?|quiz|quizzes|lecture hall|study (hall|room))\y');
UPDATE achievement_categories SET
  name = jkkn_term_fix(name),
  description = jkkn_term_fix(description)
WHERE id IN (SELECT id FROM bak_achievement_categories_eng);
