...
// Placement Page (Engineering)
const PlacementPage = lazy(() => import('@/components/cms-blocks/content/placement-page'))
...
// Institution Distinctiveness Page
const InstitutionDistinctivenessPage = lazy(() => import('@/components/cms-blocks/content/institution-distinctiveness-page'))
...
export const COMPONENT_REGISTRY: ComponentRegistry = {
  ...
  InstitutionDistinctivenessPage: {
    name: 'InstitutionDistinctivenessPage',
    displayName: 'Institution Distinctiveness Page',
    category: 'content',
    description: 'Comprehensive page showcasing the unique features and distinctive qualities of the institution including programmes, entrepreneurship, social responsibility, and civic engagement',
    icon: 'Award',
    previewImage: '/cms-previews/InstitutionDistinctivenessPage.png',
    component: InstitutionDistinctivenessPage,
    propsSchema: z.object({
      heroTitle: z.string().default('Institution Distinctiveness'),
      heroSubtitle: z.string().default(''),
      showIntroduction: z.boolean().default(true),
      introductionHeading: z.string().default('Institution Distinctiveness'),
      introductionContent: z.string().default(''),
      showHighlightBox: z.boolean().default(true),
      highlightTitle: z.string().default('J.K.K.N.'),
      highlightSubtitle: z.string().default(''),
    ...
    defaultProps: {
      ...
      highlightContent: 'Over a century of educational legacy including seven institutions: Arts & Science, Pharmacy, Engineering, Dental, Nursing, College of Education, and Polytechnic. Serves 10,000+ students annually with over 500 faculty members. Top 10 Institution in India conferred A++ Grade by NAAC. Located on 300-acre lush green campus with state-of-the-art infrastructure.',
      sections: [
        {
          id: 'efficiency-programmes',
          title: 'Efficiency of the Programmes',
          icon: 'GraduationCap',
          content: 'In addition to the main curriculum, the college also offers numerous courses on Communication Skills and Soft Skills, aimed at the development of emotional intelligence, interpersonal aptitude and boosting self-confidence. The focus is on preparing students for the current labour market, where communication, teamwork and emotional intelligence matter more than academic knowledge.',
        },
        {
          id: 'harmonizing-learning',
          title: 'Harmonizing Curricular with Extracurricular Learning Experiences',
          icon: 'BookOpen',
          content: 'Extracurricular activities not only enhance the job market employability but also establish the essential elements of teamwork, time and stress management and instills civic responsibility. The institution encourages 40 students\' associations with 100 clubs that include departmental clubs, innovation clubs, IEEE student chapters, CSI Student Branch, YRC, NSS units, Student Council, Sports clubs, cultural clubs, hobby clubs, and event management.',
        },
        {
          id: 'career-advancement',
          title: 'Assisting with Career Advancement Pathway',
          icon: 'TrendingUp',
          content: 'This institution assists the students\' advancement from their first semester, helping them to understand their career path, helping them to discover their potential, encouraging them to learn a significant contribution to the college, industry, and societal needs.',
        },
        {
          id: 'entrepreneur-ambitions',
          title: 'Enriching Entrepreneur Ambitions through IIC',
          icon: 'Lightbulb',
          content: 'The Institution\'s Innovation Council (IIC), established by the Ministry of Education, Government of India, promotes an entrepreneurial and innovation ecosystem to nurture startup ideas. The IIC supports startup founders\' activities and allows students to develop the entrepreneurial mindset.',
        },
        {
        ...
        },
        {
          ...
          icon: 'Heart',
          content: 'The institution promotes social responsibility through courses on empathetic behavior, respect for diversity, and social equality. Our institution believes in creating an environment where everyone is treated with dignity and equality irrespective of differences in social structure.',
        },
      ],
      showFooter: true,
    ...
    supportsChildren: false,
    isFullWidth: true,
    keywords: ['distinctiveness', 'unique', 'naac', 'quality', 'excellence', 'innovation', 'entrepreneurship', 'social responsibility', 'civic', 'programmes'],
    editableProps: [
      { name: 'heroTitle', type: 'string', label: 'Hero Title', required: true },
      { name: 'heroSubtitle', type: 'string', label: 'Hero Subtitle' },
      { name: 'showIntroduction', type: 'boolean', label: 'Show Introduction Section' },
      { name: 'introductionHeading', type: 'string', label: 'Introduction Heading' },
      { name: 'introductionContent', type: 'string', label: 'Introduction Content', multiline: true },
      { name: 'showHighlightBox', type: 'boolean', label: 'Show Highlight Box' },
      { name: 'highlightTitle', type: 'string', label: 'Highlight Title' },
      { name: 'highlightSubtitle', type: 'string', label: 'Highlight Subtitle' },
      { name: 'highlightContent', type: 'string', label: 'Highlight Content', multiline: true },
      { name: 'sections', type: 'array', label: 'Content Sections', itemType: 'object' },
      { name: 'showFooter', type: 'boolean', label: 'Show Footer Section' },
      { name: 'institutionName', type: 'string', label: 'Institution Name' },
  ...
  DigitalClassroomPage: {
    ...
    category: 'content',
    description: 'Premium facility page for digital classrooms with bento image gallery, animated stats, technology specification cards, learning environment features, and CTA section',
    icon: 'Monitor',
    ...
    propsSchema: z.object({
      ...
      showStats: z.boolean().default(true),
      stats: z.array(z.object({ icon: z.string(), value: z.string(), label: z.string() })).default([]),
      showTechSpecs: z.boolean().default(true),
      techSpecsTitle: z.string().default('Technology That Powers Learning'),
      techSpecs: z.array(z.object({ title: z.string(), description: z.string(), icon: z.string().optional() })).default([]),
      showFeatures: z.boolean().default(true),
      featuresTitle: z.string().default('Learning Environment'),
      features: z.array(z.object({ text: z.string(), icon: z.string().optional() })).default([]),
      showCta: z.boolean().default(true),
      ctaTitle: z.string().default('Experience the Future of Learning'),
      ctaDescription: z.string().default('Our digital classrooms combine world-class infrastructure with innovative pedagogy to create an unmatched learning experience.'),
      variant: z.enum(['modern-dark', 'modern-light']).default('modern-light'),
      showDecorations: z.boolean().default(true),
    }),
    defaultProps: {
      ...
      techSpecs: [
        { title: 'Interactive Smart Boards', description: 'Touch-enabled 86-inch smart displays with multi-user collaboration, annotation tools, and wireless screen mirroring.', icon: 'Presentation' },
        { title: 'High-Speed Connectivity', description: 'Enterprise-grade 500+ Mbps fibre-optic network with seamless Wi-Fi 6 coverage across every classroom.', icon: 'Wifi' },
        { title: '4K Multimedia Projectors', description: 'Ultra-bright 4K laser projectors with crystal-clear visuals, enabling immersive presentations and video learning.', icon: 'Projector' },
        { title: 'Digital Learning Platform', description: 'Integrated LMS access from every seat, enabling real-time quizzes, resource sharing, and assignment submissions.', icon: 'CloudCog' },
        { title: 'Audio-Visual System', description: 'Professional ceiling-mounted microphone arrays and surround speakers ensure every student hears clearly.', icon: 'Headphones' },
        { title: 'Screen Sharing & Casting', description: 'Students can wirelessly cast their devices to the classroom display for collaborative presentations.', icon: 'ScreenShare' },
      ],
      showFeatures: true,
    ...
    supportsChildren: false,
    isFullWidth: true,
    keywords: ['digital', 'classroom', 'technology', 'smart', 'interactive', 'whiteboard', 'internet', 'multimedia', 'education', 'projector', 'learning', 'facility'],
    editableProps: [
      { name: 'showHeader', type: 'boolean', label: 'Show Header' },
      { name: 'headerTitle', type: 'string', label: 'Header Title' },
      { name: 'headerSubtitle', type: 'string', label: 'Header Subtitle' },
      ...
      { name: 'showStats', type: 'boolean', label: 'Show Stats' },
      {
        name: 'stats',
        type: 'array',
        label: 'Statistics',
        ...
        itemSchema: {
          properties: {
            icon: { type: 'string', label: 'Icon Name (Monitor, Wifi, Projector, Users, GraduationCap, Laptop)', required: true },
            value: { type: 'string', label: 'Value (e.g. 60+, 500+)', required: true },
            label: { type: 'string', label: 'Label', required: true },
          },
          required: ['icon', 'value', 'label'],
        },
      },
      { name: 'showTechSpecs', type: 'boolean', label: 'Show Technology Specs' },
      { name: 'techSpecsTitle', type: 'string', label: 'Tech Specs Section Title' },
      {
        name: 'techSpecs',
        type: 'array',
        label: 'Technology Specifications',
        itemType: 'object',
        itemSchema: {
          properties: {
            title: { type: 'string', label: 'Title', required: true },
            description: { type: 'string', label: 'Description', required: true },
            icon: { type: 'string', label: 'Icon Name (Presentation, Wifi, Projector, CloudCog, Headphones, ScreenShare, Cpu, Monitor, Laptop)' },
          },
          required: ['title', 'description'],
        },
      },
      ...
      { name: 'featuresTitle', type: 'string', label: 'Features Section Title' },
      {
        name: 'features',
        type: 'array',
        label: 'Learning Environment Features',
        itemType: 'object',
        itemSchema: {
          properties: {
            text: { type: 'string', label: 'Feature Text', required: true },
            icon: { type: 'string', label: 'Icon Name (Users, Zap, Lightbulb, TabletSmartphone, BrainCircuit, Monitor, CheckCircle2, Headphones)' },
          },
          required: ['text'],
        },
      },
      { name: 'showCta', type: 'boolean', label: 'Show CTA Section' },
      { name: 'ctaTitle', type: 'string', label: 'CTA Title' },
      { name: 'ctaDescription', type: 'string', label: 'CTA Description' },
      { name: 'variant', type: 'enum', label: 'Color Scheme', options: ['modern-dark', 'modern-light'] },
      { name: 'showDecorations', type: 'boolean', label: 'Show Decorations' },
  ...
  PlacementPage: {
    name: 'PlacementPage',
    displayName: 'Placement Page',
    category: 'content',
    description: 'Full placement page with hero stats, training programs, recruiters, year-wise record, testimonials, and placement cell contact',
    icon: 'Briefcase',
    previewImage: '/cms-previews/PlacementPage.png',
    ...
    propsSchema: z.object({
      ...
      recruiters: z.array(z.object({ name: z.string(), logo: z.string() })),
    ...
    supportsChildren: false,
    keywords: ['placement', 'career', 'recruitment', 'jobs', 'training', 'engineering', 'recruiters'],
    editableProps: [
      {
        name: 'hero', type: 'object', label: 'Hero',
        itemSchema: {
          properties: {
            eyebrow: { type: 'string', label: 'Eyebrow' },
            title: { type: 'string', label: 'Title', required: true },
            subtitle: { type: 'string', multiline: true, label: 'Subtitle' },
            backgroundImage: { type: 'string', label: 'Background Image', format: 'image' },
          },
        },
      },
      {
        name: 'stats', type: 'array', label: 'Stat Cards', itemType: 'object',
        itemSchema: {
          properties: {
            label: { type: 'string', label: 'Label', required: true },
            value: { type: 'string', label: 'Value', required: true },
            icon: { type: 'enum', label: 'Icon', options: ['Briefcase', 'TrendingUp', 'Users', 'Award', 'Target', 'MessageSquare', 'Mic2', 'Code2'] },
          },
        },
      },
      { name: 'trainingTitle', type: 'string', label: 'Training Section Title' },
      { name: 'trainingSubtitle', type: 'string', multiline: true, label: 'Training Section Subtitle' },
      {
        name: 'training', type: 'array', label: 'Training Programs', itemType: 'object',
        itemSchema: {
          properties: {
            title: { type: 'string', label: 'Title', required: true },
            description: { type: 'string', multiline: true, label: 'Description', required: true },
            icon: { type: 'enum', label: 'Icon', options: ['Briefcase', 'TrendingUp', 'Users', 'Award', 'Target', 'MessageSquare', 'Mic2', 'Code2'] },
          },
        },
      },
      { name: 'recruitersTitle', type: 'string', label: 'Recruiters Section Title' },
      {
        name: 'recruiters', type: 'array', label: 'Recruiter Logos', itemType: 'object',
        itemSchema: {
          properties: {
            name: { type: 'string', label: 'Company Name', required: true },
            logo: { type: 'string', label: 'Logo URL', required: true, format: 'image' },
          },
        },
      },
      { name: 'recordTitle', type: 'string', label: 'Record Section Title' },
      {
        name: 'record', type: 'array', label: 'Year-wise Record', itemType: 'object',
        itemSchema: {
          properties: {
            year: { type: 'string', label: 'Academic Year', required: true },
            offers: { type: 'string', label: 'Offers', required: true },
            highest: { type: 'string', label: 'Highest Package', required: true },
            average: { type: 'string', label: 'Average Package', required: true },
          },
        },
      },
      { name: 'testimonialsTitle', type: 'string', label: 'Testimonials Section Title' },
      {
        name: 'testimonials', type: 'array', label: 'Success Stories', itemType: 'object',
        itemSchema: {
          properties: {
            name: { type: 'string', label: 'Alumnus Name', required: true },
            role: { type: 'string', label: 'Role', required: true },
            company: { type: 'string', label: 'Company', required: true },
            quote: { type: 'string', multiline: true, label: 'Quote', required: true },
            photo: { type: 'string', label: 'Photo URL', format: 'image' },
          },
        },
      },
      {
        name: 'placementCell', type: 'object', label: 'Placement Cell Contact',
        itemSchema: {
          properties: {
            title: { type: 'string', label: 'Section Title' },
            head: { type: 'string', label: 'Head of Placements' },
            phone: { type: 'string', label: 'Phone' },
            email: { type: 'string', label: 'Email' },
            address: { type: 'string', multiline: true, label: 'Address' },
          },
        },
      },
      {
        name: 'recruiterCta', type: 'object', label: 'Recruiter CTA Band',
        itemSchema: {
          properties: {
            title: { type: 'string', label: 'CTA Title' },
            description: { type: 'string', multiline: true, label: 'CTA Description' },
            buttonLabel: { type: 'string', label: 'Button Label' },
            buttonHref: { type: 'url', label: 'Button URL' },
          },
        },
      },
    ],
