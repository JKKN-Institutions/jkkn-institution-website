...
export const MAIN_NAAC_DATA: NAACPageProps = {
  ...
  contentSections: [
    ...
    },
    {
      ...
      overview:
        'This section presents systematic collection and analysis of feedback from various stakeholders including students, alumni, employers, parents, and faculty. The feedback mechanism ensures continuous improvement and responsiveness to stakeholder expectations.',
      documents: [
        {
          title: 'Student Feedback Analysis',
          description: 'Analysis of student feedback on teaching-learning',
          fileUrl: '/documents/naac/feedback-students.pdf',
          fileType: 'pdf',
          size: '2.6 MB',
          uploadDate: '2024-10-01',
        },
        {
          title: 'Alumni Feedback Report',
          description: 'Alumni perspectives on curriculum and skills',
          fileUrl: '/documents/naac/feedback-alumni.pdf',
          fileType: 'pdf',
          size: '2.1 MB',
        ...
        },
        {
          ...
          description: 'Industry feedback on graduate employability',
          fileUrl: '/documents/naac/feedback-employers.pdf',
          fileType: 'pdf',
          size: '1.8 MB',
          uploadDate: '2024-10-10',
        },
        {
          title: 'Consolidated Feedback Report',
          description: 'Comprehensive stakeholder feedback analysis',
          fileUrl: '/documents/naac/feedback-consolidated.pdf',
          fileType: 'pdf',
          size: '3.4 MB',
