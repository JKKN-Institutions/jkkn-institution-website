...
export const DENTAL_NAAC_DATA: NAACPageProps = {
  ...
  contentSections: [
    ...
    },
    {
      ...
      overview:
        'Systematic collection of feedback from students, interns, faculty, patients, and alumni to enhance educational quality and patient care standards.',
      documents: [
        {
          title: 'Student and Intern Feedback',
          description: 'Feedback on teaching and clinical training',
          fileUrl: '/documents/naac/dental/student-feedback.pdf',
          fileType: 'pdf',
          size: '2.8 MB',
        ...
        },
        {
          ...
          description: 'Patient feedback on dental services',
          fileUrl: '/documents/naac/dental/patient-feedback.pdf',
          fileType: 'pdf',
          size: '2.4 MB',
