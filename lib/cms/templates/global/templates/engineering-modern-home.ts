    ...
    // ============================================
    {
      ...
      props: {
        ...
        stats: [
          ...
          { value: 6, suffix: '', label: 'Top Recruiters', icon: 'building' },
    ...
    // ============================================
    {
      ...
      props: {
        ...
        programs: [
          ...
          { name: 'B.Tech Information Technology', type: 'ug', duration: '4 Years', seats: 60, icon: 'wifi', description: 'Cloud Computing, Cybersecurity, DevOps', link: '/courses-offered/ug/be-it' },
        ...
        features: [
          {
            ...
            description: 'Part of JKKN Institutions with seven decades of excellence in education',
            icon: 'award',
          },
          {
