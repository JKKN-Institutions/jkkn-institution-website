...
export const SH_SAMPLE_DATA: SHCoursePageProps = {
  ...
  ctaContact: [
    ...
    { icon: 'MapPin', label: 'Visit Us', value: 'Kumarapalayam, Namakkal - 638183', link: 'https://www.google.com/maps/search/?api=1&query=J.K.K.Nattraja+College+of+Engineering+and+Technology+Komarapalayam' },
  ],
}
