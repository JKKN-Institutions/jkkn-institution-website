...
const INSTITUTION_SEO_CONFIGS: Record<string, InstitutionSEOConfig> = {
  ...
  engineering: {
    ...
    faqs: [
      ...
      { question: 'Where is JKKN College of Engineering located?', answer: 'JKKN College of Engineering & Technology is located in Kumarapalayam, Namakkal District, Tamil Nadu, on the Salem-Coimbatore National Highway (NH-544). Just 15 km from Erode city.' },
