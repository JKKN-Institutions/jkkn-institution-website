...
// =====================================================
// CUSTOM TYPE HELPERS FOR CMS COMPONENTS MODULE
// =====================================================

export type ComponentCollection = Tables<'cms_component_collections'>
export type ComponentCollectionInsert = TablesInsert<'cms_component_collections'>
export type ComponentCollectionUpdate = TablesUpdate<'cms_component_collections'>

export type CustomComponent = Tables<'cms_custom_components'>
export type CustomComponentInsert = TablesInsert<'cms_custom_components'>
export type CustomComponentUpdate = TablesUpdate<'cms_custom_components'>

export type ExternalRegistry = Tables<'cms_external_registries'>
export type ExternalRegistryInsert = TablesInsert<'cms_external_registries'>
export type ExternalRegistryUpdate = TablesUpdate<'cms_external_registries'>

export type PreviewJob = Tables<'cms_preview_jobs'>
export type PreviewJobInsert = TablesInsert<'cms_preview_jobs'>
export type PreviewJobUpdate = TablesUpdate<'cms_preview_jobs'>

// Component source types
export type ComponentSourceType = 'manual' | 'shadcn' | 'reactbits' | 'external'
export type ComponentCategory = 'content' | 'media' | 'layout' | 'data' | 'custom'
export type PreviewStatus = 'pending' | 'generating' | 'completed' | 'failed'
export type RegistryType = 'shadcn' | 'reactbits' | 'custom'
