...
export type BEITCoursePageProps = z.infer<typeof BEITCoursePagePropsSchema>

// ============================================
// Main Component
// ============================================

export function BEITCoursePage(props: BEITCoursePageProps) {
  const {
    heroTitle,
    heroSubtitle,
    heroStats,
...
function CurriculumSection({
  ...
  return (
    <section id="curriculum" className="py-16 md:py-20 bg-gradient-to-br from-[#FFFBF5] to-[#FFF5E6]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2
          className="text-3xl md:text-4xl font-bold text-center mb-12"
          style={{ color: primaryColor }}
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {semester.subjects.map((subject, index) => (
                      ...
                      >
                        ...
                        <p className="font-semibold text-sm" style={{ color: primaryColor }}>{subject.name}</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {specializations.map((spec, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3" style={{ color: primaryColor }}>{spec.title}</h3>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {recruiters.map((recruiter, index) => (
            ...
            >
              <p className="text-center font-semibold" style={{ color: primaryColor }}>{recruiter}</p>
            </div>
          ))}
        </div>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="px-6 py-4 text-left text-sm font-semibold" style={{ color: primaryColor }}>
                  Fee Component
                </th>
                <th className="px-6 py-4 text-right text-sm font-semibold" style={{ color: primaryColor }}>
                  Amount (per year)
                </th>
              </tr>
            </thead>
...
function FacilitiesSection({
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-[#FFFBF5] to-[#FFF5E6]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
            ...
            <div key={rowIdx} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {row.map((facility, idx) => (
                ...
                >
                  ...
                  <div className="p-5">
                    {!facility.image && (
                      <h3 className="text-lg font-bold mb-2" style={{ color: primaryColor }}>{facility.name}</h3>
                    )}
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="font-semibold pr-4" style={{ color: primaryColor }}>{faq.question}</span>
                <ChevronDown
