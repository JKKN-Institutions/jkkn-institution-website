...
const defaultRuleSections: RuleSection[] = [
  ...
  },
  {
    ...
    icon: 'ClipboardList',
    rules: [
      { text: 'Learners are expected to maintain satisfactory conduct at all times while in the campus.' },
      { text: 'Punctuality in attending classes is essential. Roll call will be taken at the beginning of every lecture/learning lab hour. Learners are expected to be in their seats before the bell rings.' },
      { text: 'Learners may not leave the learning studio at will during the lecture session. Leaving without permission of the senior learner is not allowed.' },
      { text: 'Learners are expected to maintain decorum in the campus.' },
      { text: 'Damaging or destroying the college property is an offence. Any damage caused will be recovered from the learners responsible. Serious action including expulsion from the college will also be initiated against the offenders.' },
      { text: 'All forms of canvassing (Political / Religion), creating groups / factions and striking work are forbidden.' },
      { text: 'The learners are prohibited from entering the college premises with Cigarettes, Tobaccos, Alcohol, Narcotic substances, Weapons, Fire works etc. If they are found in possession of any one of them, they will be expelled from the college.' },
      ...
      { text: 'The learners are expected not to participate in any activity outside the campus which may bring disgrace to the institution.' },
      { text: 'Learners are expected not to receive visitors from outside. For unavoidable reasons permission can be obtained from the Principal to meet visitors at the reception area only.' },
      { text: 'Quarreling with co-learners or any other team member of the college will result in disciplinary action.' },
    ],
  },
  {
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        title: 'Definition',
        content: 'In this act, unless the context otherwise requires, "Ragging" means display of noisy, disorderly conduct doing any act which causes or is likely to cause physical or psychological harm or raise apprehension or fear or shame or embarrassment to a learner in any educational institution and includes:\n(a) teasing, abusing of playing practical jokes on, or causing hurt to such learner, or\n(b) asking the learner to do any act or perform something which such learner will not in the ordinary course willingly do.',
      },
      {
      ...
      {
        title: 'Dismissal of Learner',
        content: 'Any learner convicted of an offence under section 3 shall also be dismissed from the educational institution and such learner shall not be admitted in any other educational institution.',
      },
      {
        title: 'Suspension of Learners',
        content: '(1) Whenever any learner or, as the case may be, the parent or guardian, or a senior learner of an educational institution complains in writing, of ragging to the Head of the educational institution, the Head of that educational institution shall, without prejudice to the foregoing provisions, within seven days of the receipt of the complaint, enquire into the matter mentioned in the complaint and if, prima facie, it is found true, suspend the learner who is accused of the offence, and shall, immediately forward the complaint to the police station having jurisdiction over the area in which the educational institution is situated, for further action.\n(2) Where on enquiry by the Head of the Educational institution, it is proved that there is no substance prima facie, in the complaint received under sub-section (1), he shall intimate the fact, in writing, to the complainant.',
      },
    ],
  },
  {
    ...
    title: 'Dress Code',
    icon: 'Shirt',
    content: 'The learners are expected to wear decent dress while in the campus. Inappropriate dress worn by them shall be viewed seriously by the Institution. The learners found with improper dress will not be allowed into the learning auditoriums. The learners shall come with shoes / Full covered chappals only. Learners should come with the specified college dress on all working days. Wearing Lanyard ID Card is compulsory.',
  },
  {
    id: 'attendance-and-leave',
    title: 'Learners Attendance and Leave',
    icon: 'Clock',
    rules: [
      { text: 'Learners should attend the classes regularly.' },
      ...
      { text: 'Medical Leave: The learner will submit a Medical Certificate signed by a Registered Medical Practitioner on the day he/she resumes duty.' },
      { text: 'Casual Leave: The learner will submit the letter requesting permission for leave of absence in advance for the day(s) he/she will be absent.' },
      { text: 'Leave on Duty: The learner who participates in any activity outside the campus representing the college will be marked as On Duty (OD). Prior sanction should be obtained from the Principal through the HoD and the Academic Co-ordinator.' },
      { text: 'The learners who have not attained 75% of attendance (subject wise) may not be allowed to appear for the End Semester Learning Assessment.' },
    ],
  },
  {
    id: 'identity-card',
    title: 'Identity Card',
    icon: 'CreditCard',
    content: 'An identity card, displaying the details of the learners will be issued by the college. All learners shall wear the identity card (with Lanyard) while in campus. Entry into the campus will not be allowed, without wearing identity card.',
  },
  {
    id: 'wearing-helmet',
  ...
  },
  {
    ...
    title: 'Mobile Phone',
    icon: 'Smartphone',
    content: 'Possession and use of mobile phone is prohibited inside the learning studio. Severe action will be initiated against the offenders.',
  },
]
