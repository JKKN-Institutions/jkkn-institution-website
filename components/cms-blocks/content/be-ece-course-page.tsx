...
export type BEECECoursePageProps = z.infer<typeof BEECECoursePagePropsSchema>

// ============================================
// Main Component
// ============================================

export function BEECECoursePage(props: BEECECoursePageProps) {
  const {
    heroTitle,
    heroSubtitle,
    heroImage,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                src={heroImage || '/images/courses/be-ece/labs/ece-lab-33.jpg'}
                alt="Learners working in ECE learning lab at JKKN"
...
function CurriculumSection({
  ...
  return (
    <section id="curriculum" className="scroll-mt-20 py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2
          className="text-3xl md:text-4xl font-bold text-center mb-12"
          style={{ color: primaryColor }}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 mt-4 max-w-3xl mx-auto text-lg leading-relaxed">
            Experience hands-on learning in our modern learning labs equipped with industry-standard electronics and communication equipment.
          </p>
        </div>
          ...
          {rows.map((row, rowIdx) => (
            <div key={rowIdx} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {row.map((facility, idx) => (
                <div
                  key={idx}
                  className="group bg-gradient-to-br from-[#FFF9F0] to-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-gray-100"
                >
                  {/* Image */}
                  {facility.image && (
