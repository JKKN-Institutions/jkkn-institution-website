...
export function AboutSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-r from-secondary/10 to-yellow-100/50 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2" />
      ...
      <div className="relative container mx-auto px-4 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 mb-16 lg:mb-24">
          ...
          <div className={cn(
            ...
            <div className="h-full bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-100 shadow-lg shadow-black/5 hover:shadow-xl hover:border-secondary/30 transition-all">
              <div className="p-3 rounded-2xl bg-gradient-to-r from-secondary/20 to-yellow-100 w-fit mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className={cn(
            ...
            <div className="h-full bg-gradient-to-br from-secondary/10 to-yellow-50 rounded-3xl p-8 border border-secondary/20 hover:border-secondary/40 transition-colors shadow-lg shadow-secondary/5">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            ...
            >
              <div className="h-full p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-100 shadow-sm hover:shadow-xl hover:border-secondary/30 transition-all duration-300 hover:-translate-y-2">
                <div className={cn(
        ...
        <div className={cn(
          ...
          <Link
            href="/about"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold text-primary border-2 border-primary/20 hover:border-primary hover:bg-primary/5 transition-all duration-300"
          >
            Learn More About Us
