...
export function FacultyListingClient({ faculty, departments }: FacultyListingClientProps) {
  ...
  // One continuous grid — no department sections, no leadership band. Ranking
  // is carried entirely by sort order (Principal -> HOD -> seniority -> name)
  // rather than by any per-card badge or border treatment.
  const filtered = useMemo(() => {
    ...
    return faculty
      ...
      .sort(compareFacultyForDirectory)
