...
interface CityFloatingWhatsappProps {
...
export function CityFloatingWhatsapp({ cityConfig }: CityFloatingWhatsappProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-[#25d366] text-white px-5 py-3.5 rounded-full font-bold text-sm shadow-lg hover:scale-105 hover:shadow-xl transition-all animate-bounce"
    >
      <WhatsAppIcon />
